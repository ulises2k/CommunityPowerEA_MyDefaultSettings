...
function ButtonCustomIndy_1([string]$filePath) {
    ...
    if (!($comboBox1.SelectedIndex -eq "-1")) {
        ...
        #GoldStuff
        #https://www.mql5.com/en/market/product/54315?source=Site+Market+MT5+Indicator+Rating006
        if ($comboBox1.SelectedItem.ToString() -eq "GoldStuff" ) {
            Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
                CustomIndy1_Label                = "GoldStuff Label"
                CustomIndy1_Type                 = "3"
                CustomIndy1_TF                   = "5"
                CustomIndy1_PathAndName          = "Market\Gold Stuff mt5"
                CustomIndy1_ParametersStr        = "1,1,0,0,16711680,8,16760576,5,13458026,2,255,8,3937500,5,4678655,2,1,2,10,10,10,Verdana"
                CustomIndy1_BufferB              = "6"
                CustomIndy1_BufferS              = "7"
                CustomIndy1_ColorBufferB         = "6"
                CustomIndy1_ColorBufferS         = "7"
                CustomIndy1_ColorIndexB          = "0"
                ...
                CustomIndy1_Reverse              = "false"
                CustomIndy1_UseClosedBars        = "true"
                CustomIndy1_DrawShortName        = "GoldStuff"
                CustomIndy1_DrawInSubwindow      = "false"
                CustomIndy1_AllowNegativeAndZero = "true"
                CustomIndy1_OpenOn               = "1"
                CustomIndy1_MartinOn             = "0"
...
$comboBox1.Items.AddRange( @("", "DisableCustomIndy", "SuperTrend", "GoldStuff"))
...
$comboBox2.Items.AddRange( @("", "DisableCustomIndy", "SuperTrend", "GoldStuff"))
