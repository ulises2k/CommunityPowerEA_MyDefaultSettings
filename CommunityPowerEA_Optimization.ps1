# Optimization for Production (live) Setting File
#
# Autor: Ulises Cune (@Ulises2k)
# v2.1
#
# !!!! It version is for CommunityPower EA v2.35 !!!!
#
#
...
function Button([string]$filePath) {
    ...
    Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
        ...
        NextOrder_Width            = "1"
        NextOrder_Style            = "2"
        NextOrder_ColorB           = "3329330"
        NextOrder_ColorS           = "17919"
        StopLoss_Width             = "1"
        StopLoss_Style             = "1"
        ...
        BreakEven_Width            = "1"
        BreakEven_Style            = "4"
        BreakEven_ColorB           = "16760576"
        BreakEven_ColorS           = "255"
        TakeProfit_Width           = "2"
        TakeProfit_Style           = "0"
    ...
    if (($BigCandle_OpenOn -eq 0) -and ($BigCandle_MartinOn -eq 0) -and ($BigCandle_CloseOn -eq 0) -and ($BigCandle_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            BigCandle_Type = "0"
        }
    }
    ...
    if (($Oscillators_OpenOn -eq 0) -and ($Oscillators_MartinOn -eq 0) -and ($Oscillators_CloseOn -eq 0) -and ($Oscillators_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            Oscillators_Type = "0"
        }
    }
    ...
    if (($Oscillator2_OpenOn -eq 0) -and ($Oscillator2_MartinOn -eq 0) -and ($Oscillator2_CloseOn -eq 0) -and ($Oscillator2_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            Oscillator2_Type = "0"
        }
    }
    ...
    if (($Oscillator3_OpenOn -eq 0) -and ($Oscillator3_MartinOn -eq 0) -and ($Oscillator3_CloseOn -eq 0) -and ($Oscillator3_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            Oscillator3_Type = "0"
        }
    }
    ...
    if (($IdentifyTrend_OpenOn -eq 0) -and ($IdentifyTrend_MartinOn -eq 0) -and ($IdentifyTrend_CloseOn -eq 0) -and ($IdentifyTrend_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
    ...
    if (($TDI_OpenOn -eq 0) -and ($TDI_MartinOn -eq 0) -and ($TDI_CloseOn -eq 0) -and ($TDI_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            TDI_Mode = "0"
        }
    }
    ...
    if (($MACD_OpenOn -eq 0) -and ($MACD_MartinOn -eq 0) -and ($MACD_CloseOn -eq 0) -and ($MACD_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            MACD_Type = "0"
        }
    }
    ...
    if (($MACD2_OpenOn -eq 0) -and ($MACD2_MartinOn -eq 0) -and ($MACD2_CloseOn -eq 0) -and ($MACD2_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            MACD2_Type = "0"
        }
    }
    ...
    if (($DTrend_OpenOn -eq 0) -and ($DTrend_MartinOn -eq 0) -and ($DTrend_CloseOn -eq 0) -and ($DTrend_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            DTrend_Type = "0"
        }
    }
    ...
    if (($PSar_OpenOn -eq 0) -and ($PSar_MartinOn -eq 0) -and ($PSar_CloseOn -eq 0) -and ($PSar_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            PSar_Type = "0"
        }
    }
    ...
    if (($MA_Filter_1_OpenOn -eq 0) -and ($MA_Filter_1_MartinOn -eq 0) -and ($MA_Filter_1_CloseOn -eq 0) -and ($MA_Filter_1_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            MA_Filter_1_Type = "0"
        }
    }
    ...
    if (($MA_Filter_2_OpenOn -eq 0) -and ($MA_Filter_2_MartinOn -eq 0) -and ($MA_Filter_2_CloseOn -eq 0) -and ($MA_Filter_2_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            MA_Filter_2_Type = "0"
        }
    }
    ...
    if (($MA_Filter_3_OpenOn -eq 0) -and ($MA_Filter_3_MartinOn -eq 0) -and ($MA_Filter_3_CloseOn -eq 0) -and ($MA_Filter_3_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            MA_Filter_3_Type = "0"
        }
    }
    ...
    #If not select Open/OpenMartin/Close/Partial Disable Volatility Filter
    ...
    if (($VolFilter_OpenOn -eq 0) -and ($VolFilter_MartinOn -eq 0) -and ($VolFilter_CloseOn -eq 0) -and ($VolFilter_PartialCloseOn -eq 0)) {
        Set-OrAddIniValue -FilePath $filePath  -keyValueList @{
            VolFilter_Type = "0"
        }
    }
...
function Button2([string]$filePath) {
    ...
    if ($Oscillators -ne 0) {
        $fileNewName = $fileNewName + "Oscillators1_"
    }

    $Oscillator2 = [int]$inifile["Oscillator2_Type"]
    if ($Oscillator2 -ne 0) {
        $fileNewName = $fileNewName + "Oscillator2_"
    }
    ...
    $SAR = [int]$inifile["SAR_Type"]
    if ($SAR -ne 0) {
        $fileNewName = $fileNewName + "SAR_"
    }

    $MA_Filter_1 = [int]$inifile["MA_Filter_1_Type"]
    if ($MA_Filter_1 -ne 0) {
        $fileNewName = $fileNewName + "MA1_"
    }

    $MA_Filter_2 = [int]$inifile["MA_Filter_2_Type"]
    if ($MA_Filter_2 -ne 0) {
        $fileNewName = $fileNewName + "MA2_"
    }

    $MA_Filter_3 = [int]$inifile["MA_Filter_3_Type"]
    if ($MA_Filter_3 -ne 0) {
        $fileNewName = $fileNewName + "MA3_"
    }
...
$form.Text = "Optimize sections not used And Rename Strategy- CommunityPower EA"
$form.Size = '600,250'
